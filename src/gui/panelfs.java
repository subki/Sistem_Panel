 ...
 * @author ika
 */
public class panelfs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA MASTER BOX PANEL FREE STANDING");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(tfsearch, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        panelfsform frm = new panelfsform(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panelfs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    class DeleteAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int selectedOption = JOptionPane.showConfirmDialog(null, 
                                  "Yakin untuk menghapus data  Panel \n"+d, 
                                  "Hapus Data", 
        ...
        private void delete(String id) {
            String sql = "Delete from product_standing where product_no=?";
    ...
    class PrintAction extends AbstractAction {
        ...
        private void cetak(String no, int cur, String kurs) {
            try {
                ...
                exporter.setParameter(JRXlsExporterParameter.SHEET_NAMES, new String[]{"FS"});
                ...
                if(option==JOptionPane.YES_OPTION){
                    try {
                        ...
                        Logger.getLogger(panelfs.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
